...
if duracion_llamada <= 5:
    ...
    costo_llamada = 1.00 + (duracion_llamada - 5) * 0.80 #suma el precio base de la llamada (duracion de la llamada -5 segundos) y los segundos que resten se multiplica por el coste del minutoo
